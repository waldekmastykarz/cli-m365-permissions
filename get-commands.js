...
const docsPath = '/Users/waldek/github/waldekmastykarz/cli-microsoft365/docs/docs/cmd';
...
mdxFiles.forEach(file => {
  ...
  const commandMatch = content.match(/m365 ([a-z- ]+) \[options\]/);
  if (!commandMatch) {
    return;
  }
  ...
  for (const match of examplesString.matchAll(exampleRegex)) {
    ...
    // ignore commands that remove things without the --force option because
